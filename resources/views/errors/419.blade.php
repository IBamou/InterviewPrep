...
<title>419 Session Expired | InterviewPrep</title>
    ...
    <div class="w-full max-w-md text-center">
        ...
        <div class="bg-white border border-outline-variant/50 rounded-2xl p-10 shadow-sm">
            <div class="w-16 h-16 rounded-full bg-amber-50 border border-amber-200 flex items-center justify-center mx-auto mb-4">
                <span class="material-symbols-outlined text-amber-600 text-[32px]">timer_off</span>
            </div>

            <h1 class="text-[64px] font-bold text-amber-600 leading-none mb-2">419</h1>
            <h2 class="text-[18px] font-semibold text-on-surface mb-2">Session expired</h2>
