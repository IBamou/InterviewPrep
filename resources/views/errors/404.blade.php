...
<title>404 Not Found | InterviewPrep</title>
...
<body class="bg-background text-on-surface min-h-screen flex items-center justify-center p-6">
    <div class="w-full max-w-md text-center">
        ...
        <div class="bg-white border border-outline-variant/50 rounded-2xl p-10 shadow-sm">
            ...
            <h1 class="text-[64px] font-bold text-primary leading-none mb-2">404</h1>
            <h2 class="text-[18px] font-semibold text-on-surface mb-2">Page not found</h2>
