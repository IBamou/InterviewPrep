...
<h1 class="text-[32px] font-bold leading-tight mb-4">Start your journey</h1>
<p class="text-white/70 text-[14px] leading-relaxed">Organize knowledge, track mastery, and generate AI-powered interview questions tailored to your level.</p>
</div>
</section>
...
<h2 class="text-[24px] font-bold text-on-surface mb-1">Create account</h2>
<p class="text-[13px] text-on-surface-variant mb-6">Start mastering your technical interviews</p>
...
@csrf
<div>
<label class="text-[13px] font-medium text-on-surface mb-1.5 block" for="name">Full Name</label>
<input class="w-full h-10 px-3 rounded-lg border border-outline-variant/60 text-[13px] focus:border-primary focus:ring-2 focus:ring-primary/15 outline-none transition-all placeholder:text-on-surface-variant/30 @error('name') border-error @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="John Doe" type="text" required autofocus autocomplete="name"/>
...
<input class="w-full h-10 px-3 rounded-lg border border-outline-variant/60 text-[13px] focus:border-primary focus:ring-2 focus:ring-primary/15 outline-none transition-all placeholder:text-on-surface-variant/30 @error('email') border-error @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="john@company.com" type="email" required autocomplete="username"/>
...
<div>
<label class="text-[13px] font-medium text-on-surface mb-1.5 block" for="password_confirmation">Confirm Password</label>
<input class="w-full h-10 px-3 rounded-lg border border-outline-variant/60 text-[13px] focus:border-primary focus:ring-2 focus:ring-primary/15 outline-none transition-all placeholder:text-on-surface-variant/30 @error('password_confirmation') border-error @enderror" id="password_confirmation" name="password_confirmation" placeholder="••••••••" type="password" required autocomplete="new-password"/>
@error('password_confirmation')<p class="mt-1 text-[12px] text-error">{{ $message }}</p>@enderror
</div>
<button class="w-full h-10 bg-primary text-white rounded-lg text-[13px] font-medium hover:bg-primary/90 transition-all" type="submit">Create Account</button>
</form>
<p class="mt-6 text-center text-[13px] text-on-surface-variant">
Already have an account? <a class="text-primary font-medium hover:underline" href="{{ route('login') }}">Sign in</a>
</p>
</div>
</section>
</main>
