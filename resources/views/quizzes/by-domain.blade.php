<x-app-layout activeNav="quizzes" title="{{ $domain->name }} Quizzes">
    ...
    <div class="mb-6">
        ...
        <p class="font-body-md text-body-md text-on-surface-variant mt-0.5">All quizzes for this domain.</p>
    </div>
    ...
    <div class="bg-white border border-outline-variant/50 rounded-xl p-8 text-center">
        ...
        <p class="text-[13px] text-on-surface-variant/60 mb-4">Create your first quiz for this domain to test your knowledge.</p>
