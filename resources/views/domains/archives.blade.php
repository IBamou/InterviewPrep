...
<a href="{{ route('concepts.create', Auth::user()->domains()->first()?->id ?: '__placeholder__') }}" class="font-label-md text-label-md bg-primary-container text-on-primary px-4 py-1.5 rounded-lg hover:opacity-80 transition-opacity">Create Concept</a>
</div>
